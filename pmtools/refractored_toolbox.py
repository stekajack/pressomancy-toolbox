...
def unbreak_pbc_object(data_broken, box_dim):
    position_data = data_broken
    for i in range(1, len(position_data)):
        s, t = position_data[i-1], position_data[i]
        shift = min_img_dist(s, t, box_dim) - (s-t)
        position_data[i] = t - shift
